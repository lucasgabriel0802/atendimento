...
<html lang="pt-br">
    ...
    <body>
        ...
        <div id="cl-wrapper" class="fixed-menu">
                    ...
                    <div class="menu-space">
                        <div class="content">
                            <ul class="cl-vnavigation">
                                ...
                                <?php endif; ?>
                                <?php if ($_SESSION[config::getSessao()]["interno"] != ""): ?>
                                <li id="li-certificado">
                                    <a href="javascript: void(0)" onclick="carregarPagina('certificado-unidade', true, '')">
                                        <i class="fa fa-cloud-upload"></i><span>Certificado Unidade</span>
                                    </a>
                                </li>
                                <?php endif; ?>
                                <li id="li-meus-dados">
            ...
            <div id="div-modal-1" tabindex="-1" role="dialog" class="modal fade colored-header"> 
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header" style="border-radius: 5px 5px 0px 0px;">
                            <h3 style="margin: 0; display: inline;">Form Modal</h3>

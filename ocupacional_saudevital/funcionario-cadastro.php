    ...
    $('#cadastro-button-gravar').on('click', function(){
        ...
        $.ajax({
            ...
            if (data.codigo > 0){
                ...
                console.log($('#cadastro-input-matricularh').val());

                if ($('#cadastro-input-matricularh').val() != ''){
                    $.gritter.add({
                        title: 'Oba!',
                    ...
                    $.gritter.add({
                    title: 'Atenção!',
                    text: 'Cadastro efetuado sem informar a Matricula RH! Este campo é obrigatório para fins de e-social. É obrigatório o seu preenchimento em até 5 dias úteis.',
                    class_name: 'danger'
                    });
                }

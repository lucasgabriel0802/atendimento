<?php
    ...
    require_once("class/agentecausador.class.php");
...
<script>
    ...
    function pesquisar(pagina){
        ...
        $('#modal-div-pesquisa').load('agente-causador-pesquisa.php', 
                                                    {'a': 'pesquisa', 
                                                            ...
                                                            $(this).on('click', function(){
                                                                <?php
                                                                    ...
                                                                    if (isset($_POST["div"]))
                                                                        $div = $_POST["div"];
                                                                ?>
                                                                $('#<?php echo $prefixo; ?>-agente-causador').val($(this).attr('codigo'));
                                                                $('#<?php echo $prefixo; ?>-descricao-agente-causador').val($(this).attr('descricao'));
                                                                $('#<?php echo $div; ?>').modal('toggle');
                                                            });
                                                        });
                                                    });
    }

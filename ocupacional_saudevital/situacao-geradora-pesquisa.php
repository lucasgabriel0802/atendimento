<?php
    ...
    require_once("class/situacaogeradora.class.php");
...
<script>
    ...
    function pesquisar(pagina){
        ...
        $('#modal-div-pesquisa').load('situacao-geradora-pesquisa.php', 
                                                    {'a': 'pesquisa', 
                                                     ...
                                                     'pagina': pagina 
                                                        ...
                                                        $('#modal-div-pesquisa a').each(function(){
                                                            $(this).on('click', function(){
                                                                ...
                                                                ?>
                                                                $('#<?php echo $prefixo; ?>-situacao-geradora').val($(this).attr('codigo'));
                                                                $('#<?php echo $prefixo; ?>-descricao-situacao-geradora').val($(this).attr('descricao'));

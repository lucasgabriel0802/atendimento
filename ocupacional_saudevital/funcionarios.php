...
if (isset($_POST["a"])) {
    ...
    if ($acao == "pesquisa") {
        ...
        if (isset($_POST["situacao"])){
            if($_POST["situacao"] == 'A')
                $filtro["A.SITUACAO"] = 'ATIVO';
            if($_POST["situacao"] == 'I')
                $filtro["A.SITUACAO"] = 'INATIVO';            
        }
        ...
        if ($fu->buscar($filtro, $limite, array("A.NOME" => "ASC"))) {
            ...
            $cab->addItem("", array("style" => "width: 78px"));
            ...
            for ($i = 0; $i < $fu->getTotalLista(); $i++) {
                ...
                $demissao = '';
                if ($fu->getItemLista($i)->getDataDemissao() != ''){
                    // echo $fu->getItemLista($i)->getDataDemissao();
                    $demissao = date("d/m/Y", strtotime($fu->getItemLista($i)->getDataDemissao()));
                }
        ...
        if (isset($_POST["codigo"])) {
            if (is_numeric($_POST["codigo"])) {
                ...
                if (isset($_POST["datademissao"]) and (trim($_POST["datademissao"]) != '')) {
                    $editar["DATADEMISSAO"] = funcoes::converterData($_POST["datademissao"]);

                }elseif(isset($_POST["datademissao"]) and (trim($_POST["datademissao"]) == '')) {
                    $editar["DATADEMISSAO"] = 'null';
                }
    ...
    <div class="block-flat">
        <div class="form-group-sm">
            ...
            <div class="col-md-4">
                ...
                <select class="form-control input-sm" id="modal-funcionario-select-situacao">
            ...
            <div class="modal-body">
                ...
                <div class="form-group-sm">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" class="form-control input-sm" id="cadastro-input-data-demissao">
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="form-group-sm">
                    ...
                    <div class="col-sm-3">
                        <label>* Cadastrado no evento S2200, S2190 ou S2300</label>
                        <input type="hidden">
                    </div>
                    <div class="clearfix"></div>
                </div>
...
<script>
    ...
    $('document').ready(function() {
        ...
        $('#cadastro-input-data-demissao').datepicker({
            autoclose: true
        });
    ...
    function editarFuncionario(codigo) {
        $.ajax({
            ...
            data: {
                ...
                datademissao: $('#cadastro-input-data-demissao').val()
            },
            cache: false,
            async: true,
            success: function(data) {
                ...
                if (data.codigo > 0) {
                    ...
                    $('#cadastro-input-data-demissao').val('');
                    pesquisarFuncionario('1');
                }
            },
            error: function() {
    ...
    function pesquisarFuncionario(pagina) {
        ...
        $('#div-pesquisa-funcionario').load('funcionarios.php', {
            ...
            'situacao': $('#modal-funcionario-select-situacao').find('option:selected').val(),
            'pagina': pagina
        }, function() {
            $('#div-pesquisa-funcionario a').each(function() {
                $(this).on('click', function() {
                    ...
                    if ($(this).attr('acao') == 'editar') {
                        ...
                        $('#modal-editar').find('h2').first().text($(this).attr('nome'));
                        ...
                        $('#modal-editar').find('#cadastro-input-data-demissao').first().val($(this).attr('data-demissao'));

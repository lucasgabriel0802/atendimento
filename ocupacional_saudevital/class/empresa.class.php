...
class empresa implements iface {
    ...
    private $permiteDigitalizacaoASO = false;
    private $modeloArquivoDownload = 0;
    private $filialProtheus = "";
    private $gerarXMLEsocial = "";
    ...
    function getPermiteDigitalizacaoASO() { return $this->permiteDigitalizacaoASO; }
    function getModeloArquivoDownload(){return $this->modeloArquivoDownload; }
    function getFilialProtheus(){return $this->filialProtheus; }
    function getGerarXMLEsocial(){return $this->gerarXMLEsocial; }
    ...
    function setPermiteDigitalizacaoASO($valor) { $this->permiteDigitalizacaoASO = $valor; }
    function setModeloArquivoDownload($valor){$this->modeloArquivoDownload = $valor; }
    function setFilialProtheus($valor){$this->filialProtheus = $valor; }
    function setGerarXMLESocial($valor){$this->gerarXMLEsocial = $valor; }
    ...
    function buscar($filtro = null, $limite = null, $ordem = null){
        $select = array("A.CODIGO", "A.RAZAOSOCIAL", "A.NOMEFANTASIA",
                        ...
                        "A.SENHACERTIFICADODIGITAL", "A.VALIDADECERTIFICADODIGITAL",
                        "A.PERMITEDIGITALIZACAOASO","A.NUMEROFILIAL_PROTHEUS", "A.ARQUIVO_ESOCIAL_PERSONALIZADO",
                        "A.GERARXML_ESOCIAL");
        ...
        for ($i = 0; $i < count($ret); $i++){
            ...
            $e->setPermiteDigitalizacaoASO($ret[$i]["PERMITEDIGITALIZACAOASO"] == "S");

            $e->setModeloArquivoDownload($ret[$i]["ARQUIVO_ESOCIAL_PERSONALIZADO"]);
            $e->setFilialProtheus($ret[$i]["NUMEROFILIAL_PROTHEUS"]);
            ...
            $e->setGerarXMLESocial($ret[$i]["GERARXML_ESOCIAL"]);
    ...
    function salvarArquivoCertificadoDigital($unidade, $empresa, $certificado, $senha, $validade){
        $certificado = $this->getArquivoCertificadoDigital();
        $fp = fopen($_SERVER['DOCUMENT_ROOT'] . "/teste.pfx","wb");
        // fwrite($fp,$conteudo);
        fclose($fp);
        echo "Salvou";
        die;

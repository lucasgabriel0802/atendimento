...
class registrocat implements iface
{
    ...
    function getDataComunObito()
    {
        return $this->datacomunobito;
    }
    function getUnidadeTrabalho()
    {
        return $this->unidadetrabalho;
    }
    function getNumeroCAT()
    {
    ...
    function getCodigoCbo()
    {
        return $this->codigocbo;
    }
    function getFiliacaoPs()
    {
        return $this->filiacaops;
    }
    function getAposentado()
    {
    ...
    function getDataAcidente()
    {
        return $this->dataacidente;
    }
    function getHoraAcidente()
    {
        return $this->horaacidente;
    }
    function getQtdeHorasTrabalho()
    {
        return $this->qtdehorastrabalho;
    }
    function getTipoAcidente()
    {
        return $this->tipoacidente;
    }
    function getHouveAfastamento()
    {
        return $this->houveafastamento;
    }
    function getUltimoDiaTrab()
    {
        return $this->ultimodiatrab;
    }
    function getLocalAcidente()
    {
        return $this->localacidente;
    }
    function getLocalEspecifica()
    {
        return $this->localespecifica;
    }
    function getLocalCnpj()
    {
        return $this->localcnpj;
    }
    function getLocalCidade()
    {
        return $this->localcidade;
    }
    function getLocalBairro()
    {
        return $this->localbairro;
    }
    function getLocalUf()
    {
        return $this->localuf;
    }
    function getPartesAtingidas()
    {
        return $this->partesatingidas;
    }
    function getAgenteCausador()
    {
    ...
    function getRegistroPolicial()
    {
        return $this->registropolicial;
    }
    function getHouveMorte()
    {
        return $this->houvemorte;
    }
    function getTestem1_Nome()
    {
        return $this->testem1_nome;
    }
    function getTestem1_Cep()
    {
        return $this->testem2_cep;
    }
    function getTestem1_Endereco()
    {
        return $this->testem1_endereco;
    }
    function getTestem1_EndNumer()
    {
        return $this->testem1_endnumer;
    }
    function getTestem1_EndCompl()
    {
        return $this->testem1_endcompl;
    }
    function getTestem1_Bairro()
    {
        return $this->testem1_bairro;
    }
    function getTestem1_Cidade()
    {
        return $this->testem1_cidade;
    }
    function getTestem1_Estado()
    {
        return $this->testem1_estado;
    }
    function getTestem1_DddFone()
    {
        return $this->testem1_dddfone;
    }
    function getTestem1_PreFone()
    {
        return $this->testem1_prefone;
    }
    function getTestem1_NumFone()
    {
        return $this->testem1_numfone;
    }
    function getTestem2_Nome()
    {
        return $this->testem2_nome;
    }
    function getTestem2_Cep()
    {
        return $this->testem2_cep;
    }
    function getTestem2_Endereco()
    {
        return $this->testem2_endereco;
    }
    function getTestem2_EndNumer()
    {
        return $this->testem2_endnumer;
    }
    function getTestem2_EndCompl()
    {
        return $this->testem2_endcompl;
    }
    function getTestem2_Bairro()
    {
        return $this->testem2_bairro;
    }
    function getTestem2_Cidade()
    {
        return $this->testem2_cidade;
    }
    function getTestem2_Estado()
    {
        return $this->testem2_estado;
    }
    function getTestem2_DddFone()
    {
        return $this->testem2_dddfone;
    }
    function getTestem2_PreFone()
    {
        return $this->testem2_prefone;
    }
    function getTestem2_NumFone()
    {
        return $this->testem2_numfone;
    }
    function getTipoAcidente_ESocial()
    {
        return $this->tpacidente_esocial;
    }
    function getSituacaoGeradoraCat()
    {
        return $this->situacaogeradora_cat;
    }
    function getCodigoIBGE_Cidade()
    {
        return $this->codigoibge_cidade;
    }
    function getCodigoAgenteCausador()
    {
        return $this->codigoagentecausador;
    }
    function getCodigoNaturezaLesao()
    {
        return $this->codigonaturezalesao;
    }
    function getCodigoCid10()
    {
        return $this->codigocid10;
    }
    function getTipoInscricaoRegistrador()
    {
        return $this->tipoinscricaoregistrador;
    }
    function getCnpjRegistrador()
    {
        return $this->cnpjregistrador;
    }
    function getIniciativaCat()
    {
        return $this->iniciativacat;
    }
    function getDescricaoLogradouro()
    {
    ...
    function getCepLocalAcidente()
    {
        return $this->ceplocalacidente;
    }
    function getAtestadoCnes()
    {
        return $this->atestado_cnes;
    }
    function getAtestadoData()
    {
        return $this->atestado_data;
    }
    function getAtestadoHora()
    {
        return $this->atestado_hora;
    }
    function getAtestadoInsternacao()
    {
        return $this->atestado_internacao;
    }
    function getAtestadoDuracaoDias()
    {
        return $this->atestado_duracaodias;
    }
    function getAtestadoDiagnostico()
    {
        return $this->atestado_diagnostico;
    }
    function getAtestadoNomeEmitente()
    {
        return $this->atestado_nomeemitente;
    }
    function getAtestadoOrgaoClasse()
    {
        return $this->atestado_orgaoclasse;
    }
    function getAtestadoNumeroInscricao()
    {
        return $this->atestado_numeroinscricao;
    }
    function getAtestadoUfOrgaoClasse()
    {
        return $this->atestado_uforgaoclasse;
    }
    function getDataCatOrigem()
    {
        return $this->data_cat_origem;
    }
    function getNumeroCatOrigem()
    {
    ...
    function getCodigoParteAtingida()
    {
        return $this->codigoparteatingida;
    }
    function getCodigoLateralidade()
    {
        return $this->codigolateralidade;
    }
    function getDescricaoComplementarLesao()
    {
        return $this->descricaocomplementarlesao;
    }
    function getAtestadoObservacao()
    {
        return $this->atestado_observacao;
    }
    ...
    function setLocalEmissao($valor)
    {
        $this->localemissao = $valor;
    }
    function setDataEmissao($valor)
    {
        $this->dataemissao = $valor;
    }
    function setEmitente($valor)
    {
        $this->emitente = $valor;
    }
    function setTipoCAT($valor)
    {
        $this->tipocat = $valor;
    }
    function setDataComunObito($valor)
    {
        $this->datacomunobito = $valor;
    }
    function setUnidadeTrabalho($valor)
    {
        $this->unidadetrabalho = $valor;
    }
    function setNumeroCAT($valor)
    {
        $this->numerocat = $valor;
    }
    function setDataRegistro($valor)
    {
        $this->dataregistro = $valor;
    }
    function setNomeFuncionario($valor)
    {
        $this->nomefuncionario = $valor;
    }
    function setDataNascimento($valor)
    {
    ...
    function setCtpsNumero($valor)
    {
        $this->ctpsnumero = $valor;
    }
    function setCtpsSerie($valor)
    {
        $this->ctpsserie = $valor;
    }
    function setCtpsData($valor)
    {
        $this->ctpsdata = $valor;
    }
    function setCtpsUF($valor)
    {
        $this->ctpsuf = $valor;
    }
    function setRemuneracao($valor)
    {
        $this->remuneracao = $valor;
    }
    function setRgNumero($valor)
    {
        $this->rgnumero = $valor;
    }
    function setRgDataEmissao($valor)
    {
        $this->rgdataemissao = $valor;
    }
    function setRgEmissor($valor)
    {
        $this->rgemissor = $valor;
    }
    function setRgUf($valor)
    {
        $this->rguf = $valor;
    }
    function setPisPasep($valor)
    {
        $this->pispasep = $valor;
    }
    function setEndCep($valor)
    {
        $this->endcep = $valor;
    }
    ...
    function setEndNumero($valor)
    {
        $this->endnumero = $valor;
    }
    ...
    function setDddFone($valor)
    {
        $this->dddfone = $valor;
    }
    function setPreFone($valor)
    {
        $this->prefone = $valor;
    }
    function setNumFone($valor)
    {
        $this->numfone = $valor;
    }
    function setOcupacao($valor)
    {
        $this->ocupacao = $valor;
    }
    function setCodigoCbo($valor)
    {
        $this->codigocbo = $valor;
    }
    function setFiliacaoPs($valor)
    {
        $this->filiacaops = $valor;
    }
    function setAposentado($valor)
    {
        $this->aposentado = $valor;
    }
    function setAreas($valor)
    {
        $this->areas = $valor;
    }
    function setDataAcidente($valor)
    {
        $this->dataacidente = $valor;
    }
    function setHoraAcidente($valor)
    {
        $this->horaacidente = $valor;
    }
    function setQtdeHorasTrabalho($valor)
    {
        $this->qtdehorastrabalho = $valor;
    }
    function setTipoAcidente($valor)
    {
        $this->tipoacidente = $valor;
    }
    function setHouveAfastamento($valor)
    {
        $this->houveafastamento = $valor;
    }
    function setUltimoDiaTrab($valor)
    {
        $this->ultimodiatrab = $valor;
    }
    function setLocalAcidente($valor)
    {
        $this->localacidente = $valor;
    }
    function setLocalEspecifica($valor)
    {
        $this->localespecifica = $valor;
    }
    function setLocalCnpj($valor)
    {
        $this->localcnpj = $valor;
    }
    function setLocalCidade($valor)
    {
        $this->localcidade = $valor;
    }
    function setLocalBairro($valor)
    {
        $this->localbairro = $valor;
    }
    function setLocalUf($valor)
    {
        $this->localuf = $valor;
    }
    function setPartesAtingidas($valor)
    {
        $this->partesatingidas = $valor;
    }
    function setAgenteCausador($valor)
    {
        $this->agentecausador = $valor;
    }
    function setSituacao($valor)
    {
        $this->situacao = $valor;
    }
    function setRegistroPolicial($valor)
    {
        $this->registropolicial = $valor;
    }
    function setHouveMorte($valor)
    {
        $this->houvemorte = $valor;
    }
    function setTestem1_Nome($valor)
    {
        $this->testem1_nome = $valor;
    }
    function setTestem1_Cep($valor)
    {
        $this->testem2_cep = $valor;
    }
    function setTestem1_Endereco($valor)
    {
        $this->testem1_endereco = $valor;
    }
    function setTestem1_EndNumer($valor)
    {
        $this->testem1_endnumer = $valor;
    }
    function setTestem1_EndCompl($valor)
    {
        $this->testem1_endcompl = $valor;
    }
    function setTestem1_Bairro($valor)
    {
        $this->testem1_bairro = $valor;
    }
    function setTestem1_Cidade($valor)
    {
        $this->testem1_cidade = $valor;
    }
    function setTestem1_Estado($valor)
    {
        $this->testem1_estado = $valor;
    }
    function setTestem1_DddFone($valor)
    {
        $this->testem1_dddfone = $valor;
    }
    function setTestem1_PreFone($valor)
    {
        $this->testem1_prefone = $valor;
    }
    function setTestem1_NumFone($valor)
    {
        $this->testem1_numfone = $valor;
    }
    function setTestem2_Nome($valor)
    {
        $this->testem2_nome = $valor;
    }
    function setTestem2_Cep($valor)
    {
        $this->testem2_cep = $valor;
    }
    function setTestem2_Endereco($valor)
    {
        $this->testem2_endereco = $valor;
    }
    function setTestem2_EndNumer($valor)
    {
        $this->testem2_endnumer = $valor;
    }
    function setTestem2_EndCompl($valor)
    {
        $this->testem2_endcompl = $valor;
    }
    function setTestem2_Bairro($valor)
    {
        $this->testem2_bairro = $valor;
    }
    function setTestem2_Cidade($valor)
    {
        $this->testem2_cidade = $valor;
    }
    function setTestem2_Estado($valor)
    {
        $this->testem2_estado = $valor;
    }
    function setTestem2_DddFone($valor)
    {
        $this->testem2_dddfone = $valor;
    }
    function setTestem2_PreFone($valor)
    {
        $this->testem2_prefone = $valor;
    }
    function setTestem2_NumFone($valor)
    {
        $this->testem2_numfone = $valor;
    }
    function setTipoAcidente_ESocial($valor)
    {
        $this->tpacidente_esocial  = $valor;
    }
    function setSituacaoGeradoraCat($valor)
    {
        $this->situacaogeradora_cat  = $valor;
    }
    function setCodigoIBGE_Cidade($valor)
    {
        $this->codigoibge_cidade  = $valor;
    }
    function setCodigoAgenteCausador($valor)
    {
        $this->codigoagentecausador  = $valor;
    }
    function setCodigoNaturezaLesao($valor)
    {
        $this->codigonaturezalesao  = $valor;
    }
    function setCodigoCid10($valor)
    {
        $this->codigocid10  = $valor;
    }
    function setTipoInscricaoRegistrador($valor)
    {
        $this->tipoinscricaoregistrador  = $valor;
    }
    function setCnpjRegistrador($valor)
    {
        $this->cnpjregistrador  = $valor;
    }
    function setIniciativaCat($valor)
    {
        $this->iniciativacat  = $valor;
    }
    function setDescricaoLogradouro($valor)
    {
        $this->descricaologradouro  = $valor;
    }
    function setNumeroLogradouro($valor)
    {
        $this->numerologradouro  = $valor;
    }
    function setCepLocalAcidente($valor)
    {
        $this->ceplocalacidente  = $valor;
    }
    function setAtestadoCnes($valor)
    {
        $this->atestado_cnes  = $valor;
    }
    function setAtestadoData($valor)
    {
        $this->atestado_data = $valor;
    }
    function setAtestadoHora($valor)
    {
        $this->atestado_hora = $valor;
    }
    function setAtestadoInsternacao($valor)
    {
        $this->atestado_internacao  = $valor;
    }
    function setAtestadoDuracaoDias($valor)
    {
        $this->atestado_duracaodias  = $valor;
    }
    function setAtestadoDiagnostico($valor)
    {
        $this->atestado_diagnostico  = $valor;
    }
    function setAtestadoNomeEmitente($valor)
    {
        $this->atestado_nomeemitente  = $valor;
    }
    function setAtestadoOrgaoClasse($valor)
    {
        $this->atestado_orgaoclasse  = $valor;
    }
    function setAtestadoNumeroInscricao($valor)
    {
        $this->atestado_numeroinscricao  = $valor;
    }
    function setAtestadoUfOrgaoClasse($valor)
    {
        $this->atestado_uforgaoclasse  = $valor;
    }
    function setDataCatOrigem($valor)
    {
        $this->data_cat_origem = $valor;
    }
    function setNumeroCatOrigem($valor)
    {
        $this->numero_cat_origem  = $valor;
    }
    function setObservacao($valor)
    {
        $this->observacao  = $valor;
    }
    function setCodigoParteAtingida($valor)
    {
        $this->codigoparteatingida  = $valor;
    }
    function setCodigoLateralidade($valor)
    {
        $this->codigolateralidade  = $valor;
    }
    function setDescricaoComplementarLesao($valor)
    {
        $this->descricaocomplementarlesao = $valor;
    }
    function setAtestadoObservacao($valor)
    {
        $this->atestado_observacao = $valor;
    }
    ...
    {
        $select = array(
            "A.UNIDADE", "A.EMPRESA", "A.NUMERO", "A.FUNCIONARIO", "A.LOCALEMISSAO",
    ...
    function excluirCAT($unidade, $empresa, $numero)
    {
    ...
    function montarXML($unidade, $empresa, $numero)
    {
        ...
        if ($cat->buscar(array("A.UNIDADE" => $unidade, "A.EMPRESA" => $empresa, "A.NUMERO" => $numero))) {
            ...
            if ($funcionario->buscar(array("A.UNIDADE" => $unidade, "A.EMPRESA" => $empresa, "A.MATRICULA" => $cat->getFuncionario()))) {
                ...
                $emp = new empresa();
                $uni = new unidade();
                if ($uni->buscar(array("CODIGO" => $unidade)))
                    $uni = $uni->getItemLista(0);
                ...
                if (isset($cert)) {
                    $cert = $uni->getArquivoCertificadoDigital();
                }
                ...
                $certificate = null;
                $cnpjTransmissor = substr(funcoes::somenteNumeros($emp->getCNPJCPF()), 0, 8);
                // try {
                //     $certificate = Certificate::readPfx($cert, $password);
                //     $cnpjTransmissor = substr(funcoes::somenteNumeros($certificate->getCnpj()), 0, 8); //numero do documento
                // } catch (\Exception $th) {
                //      echo $th->getMessage();
                //      die;
                // }
                ...
                $config = [
                    ...
                    'empregador' => [
                        ...
                        'nmRazao' => funcoes::removerCaracteres(utf8_encode($emp->getNomeFantasia())),
                    ],
                    'transmissor' => [
                        'tpInsc' => 1, //1-CNPJ, 2-CPF
                        'nrInsc' => $cnpjTransmissor,
                    ],
                ];

                $configJson = json_encode($config);
                // print_r(funcoes::removerCaracteres(utf8_encode($emp->getNomeFantasia())));
                ...
                try {
                    ...
                    $xmlPronto = $xml->toXML();
                    if (substr($xmlPronto, 0, 14) != '<eSocial xmlns') {
                        $cat->excluirCAT(

                                                ...
                                                if (trim($_POST["setor"]) != ""){
                                                    ...
                                                    if (trim($_POST["funcao"]) != ""){
                                                        ...
                                                        //if (trim($_POST["cargo"]) != ""){
                                                            ...
                                                            //}else{
                                                            //    $retorno["codigo"] = 34;
                                                            //    $retorno["mensagem"] = "Selecione o revezamento!";
                                                            //}
...
<script>
    ...
    $('#cadastro-button-pesquisar-setor').on('click', function(){
       if ($('#cadastro-input-descricao-posto').val() != ''){                    
            $('#div-modal').modal();
            ...
            $.gritter.add({
                title: 'Ops!',
                text:  "Selecione um Posto de Trabalho !",
                class_name: 'danger'
            });           
       };
    });  
    ...
    $('#cadastro-button-pesquisar-funcao').on('click', function(){
       if ($('#cadastro-input-nome-setor').val() != ''){                    
            $('#div-modal').modal();

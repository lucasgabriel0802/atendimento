            ...
            if (isset($_POST["data"])){
                if (funcoes::validarData($_POST["data"])){
                    ...
                    if ($em->buscar(array("A.UNIDADE" => $_SESSION[config::getSessao()]["unidade"],
                        ...
                        $bloqueado = $em->getItemLista(0)->getBloqueado();
                    }
                    ...
                    if ((($limiteAgendamento == 0) || ($totalAgendado < $limiteAgendamento)) && ($bloqueado==false)){
                        // se não tiver limite ou o limite for menor que o total
                        $medicos = array();
                        ...
                        $filtro = array("B.CODIGOUNIDADE" => $_SESSION[config::getSessao()]["unidade"],
                                        "B.DATA" => $data,
                                        "A.HORA" => array($hora, ">="));
                        ...
                        if ($ag->buscarHorariosLivres($filtro)){
                            ...
                            $retorno["codigo"] = 4;
                            $retorno["mensagem"] = "Nenhum horário disponível!";
                        }
                    }else{
                        $retorno["codigo"] = 3;
                        if($bloqueado==false)
                            ...
                            $retorno["mensagem"] = "O limite de agendamento para esse dia foi excedido! Nenhum horário disponível!";
                    }
                }else{
                    $retorno["codigo"] = 2;
            ...
            if ($acao == "marcar"){
                            ...
                            if (funcoes::validarHora($_POST["hora"])){
                                ...
                                if ($ag->buscarHorariosLivres(array("A.CODIGOUNIDADE" => $_SESSION[config::getSessao()]["unidade"],
                                    ...
                                    if ($ag->marcarControle($_SESSION[config::getSessao()]["unidade"], $codigo, $hora)){
                                        ...
                                        $retorno["codigo"] = 6;
                                        $retorno["mensagem"] = "Não foi possível marcar o horário!<br>Verifique se o mesmo está liberado!";
                                    }
                                }else{
                                    $retorno["codigo"] = 5;
                                ...
                                $retorno["codigo"] = 4;
                                $retorno["mensagem"] = "Hora informada não válida!";
                            }
                        }else{
                            $retorno["codigo"] = 3;
                            $retorno["mensagem"] = "Hora não encontrada!";
                        }
                    }else{
                        $retorno["codigo"] = 2;
                        $retorno["mensagem"] = "Identificador do agendamento inválido!";
                    }
                }else{
                    $retorno["codigo"] = 1;
                    $retorno["mensagem"] = "Identificador do agendamento não encontrado!";
                }
                ...
                if ($acao == "desmarcar"){
                    if (isset($_POST["codigo"])){
                        ...
                        echo "Identificador não informado!";
                }else
                    if ($acao == "gravar"){
                        $retorno = array("codigo" => 0, "mensagem" => "");
                        ...
                        if ($ag->buscarDataAgenda($_SESSION[config::getSessao()]["unidade"], $codigo)){
                            ...
                            if ($ag->buscarHorarioMarcado($_SESSION[config::getSessao()]["unidade"], $codigo, $hora)){
                                // valida se horário está marcado
                                $intervaloAgendamento = 0;
                                $limiteAgendamento = 0;
                                $em = new empresa();
                                if ($em->buscar(array("A.UNIDADE" => $_SESSION[config::getSessao()]["unidade"],
                                ...
                                $retorno["codigo"] = 16;
                                $retorno["mensagem"] = "O horário não está marcado para agendamento!";
                            }
                        }else{
                            $retorno["codigo"] = 15;
                    ...
                    <div class="form-group-sm" style="margin-left: 13px;">
                        <div class="col-md-12">
                            <h3>
                                ...
                                <br/>
                                <center>
                                    Não é possível agendar novos horários devido a pendências financeiras.
                                </center>
                                <br/>
                                <br/>
                            </h3>
                ...
                <div class="widget-block white-box calendar-box-sm">
                    ...
                    <div class="col-md-6" style="padding-top: 10px;">
                        ...
                        <div style="padding-top: 10px; text-align: right">
                            <button class="btn btn-primary btn-xs" id="form-button-continuar">Próximo</button>
            ...
            <div class="form-group-sm">
                <div class="col-sm-12 col-md-12 col-lg-6 col-lg-offset-3" style="height: 58px;">
                    ...
                    <div class="input-group">
                        <input type="hidden" id="form-input-funcionario" value="<?= isset($_POST['func']) ?>">

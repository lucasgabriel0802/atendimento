...
if (isset($_POST["a"])) {
    ...
    if ($acao == "gravar") {
        ...
        if (!isset($_POST["cat-input-data-emissao"])) {
            ...
            if (!isset($_POST["cat-input-horas-trabalhadas"])) {
            $retorno["codigo"] = 6;
            ...
            if (!isset($_POST["cat-input-funcionario-acidente-numero"])) {
            $retorno["codigo"] = 39;
            ...
            $retorno["codigo"] = 42;
            $retorno["mensagem"] = "CNPN do local do acidente não é válido!";
        } else
        ...
        if ($retorno["codigo"] == 0) {
            ...
            $val = array(
                ...
                "NUMEROCAT"      => $_POST["cat-input-numero-inss"],
                "NOMEFUNCIONARIO" => utf8_decode($_POST["cat-input-funcionario-nome"]),
                "NOMEMAEFUNCION" => utf8_decode($_POST["cat-input-funcionario-nome-mae"]),
                "SEXO"           => $_POST["cat-input-funcionario-select-sexo"],
                "ESTADOCIVIL"    => $_POST["cat-input-funcionario-select-estado-civil"],
                "CTPSNUMERO"     => $_POST["cat-input-funcionario-numero-ctps"],
                "CTPSSERIE"      => $_POST["cat-input-funcionario-serie-ctps"],
                "CTPSUF"         => $_POST["cat-input-funcionario-select-uf-ctps"],
                // "REMUNERACAO"    => str_replace(',', '.', $_POST["cat-input-funcionario-remuneracao"]),
                "RGNUMERO"       => $_POST["cat-input-funcionario-numero-rg"],
                "RGEMISSOR"      => $_POST["cat-input-funcionario-emissor-rg"],
                "RGUF"           => $_POST["cat-input-funcionario-select-uf-rg"],
                "PISPASEP"       => $_POST["cat-input-funcionario-numero-pis"],
                "ENDCEP"         => $_POST["cat-input-funcionario-cep"],
                "ENDERECO"       => utf8_decode($_POST["cat-input-funcionario-endereco"]),
                "ENDNUMERO"      => $_POST["cat-input-funcionario-numero"],
                "BAIRRO"         => utf8_decode($_POST["cat-input-funcionario-bairro"]),
                "CIDADE"         => utf8_decode($_POST["cat-input-funcionario-cidade"]),
                "ESTADO"         => $_POST["cat-input-funcionario-select-uf"],
                "DDDFONE"        => $_POST["cat-input-funcionario-ddd"],
                "PREFONE"        => $_POST["cat-input-funcionario-input-prefone"],
                "NUMFONE"        => $_POST["cat-input-funcionario-numfone"],
                "OCUPACAO"       => utf8_decode($_POST["cat-input-funcionario-ocupacao"]),
                "CODIGOCBO"      => $_POST["cat-input-funcionario-cbo"],
                "FILIACAOPS"     => $_POST["cat-input-funcionario-filiacao-ps"],
                "APOSENTADO"     => $_POST["cat-input-funcionario-select-aposentado"],
                "AREAS"          => $_POST["cat-input-funcionario-select-area"],
                ...
                "PARTESATINGIDAS" => utf8_decode($_POST["cat-input-parte-atingida"]),
                // "AGENTECAUSADOR"  => substr($_POST["cat-input-funcionario-descricao-agente-causador"], 0, 30),
                "SITUACAO"        => utf8_decode($_POST["cat-input-atestado-descricao-situacao"]),
                "REGISTROPOLICIAL" => $_POST["cat-input-registro-policial"],
                "HOUVEMORTE"       => $_POST["cat-input-select-obito"],
                "TESTEM1_NOME"     => utf8_decode($_POST["cat-input-testemunha1-nome"]),
                "TESTEM1_CEP"      => $_POST["cat-input-testemunha1-cep"],
                "TESTEM1_ENDERECO" => utf8_decode($_POST["cat-input-testemunha1-endereco"]),
                "TESTEM1_ENDNUMER" => $_POST["cat-input-testemunha1-numero"],
                "TESTEM1_ENDCOMPL" => $_POST["cat-input-testemunha1-complemento"],
                "TESTEM1_BAIRRO"   => utf8_decode($_POST["cat-input-testemunha1-bairro"]),
                "TESTEM1_CIDADE"   => utf8_decode($_POST["cat-input-testemunha1-cidade"]),
                "TESTEM1_ESTADO"   => $_POST["cat-input-testemunha1-select-uf"],
                "TESTEM1_DDDFONE"  => $_POST["cat-input-testemunha1-ddd"],
                "TESTEM1_PREFONE"  => $_POST["cat-input-testemunha1-prefone"],
                "TESTEM1_NUMFONE"  => $_POST["cat-input-testemunha1-numfone"],
                "TESTEM2_NOME"     => utf8_decode($_POST["cat-input-testemunha2-nome"]),
                "TESTEM2_CEP"      => $_POST["cat-input-testemunha2-cep"],
                "TESTEM2_ENDERECO" => utf8_decode($_POST["cat-input-testemunha2-endereco"]),
                "TESTEM2_ENDNUMER" => $_POST["cat-input-testemunha2-numero"],
                "TESTEM2_ENDCOMPL" => $_POST["cat-input-testemunha2-complemento"],
                "TESTEM2_BAIRRO"   => utf8_decode($_POST["cat-input-testemunha2-bairro"]),
                "TESTEM2_CIDADE"   => utf8_decode($_POST["cat-input-testemunha2-cidade"]),
                "TESTEM2_ESTADO"   => $_POST["cat-input-testemunha2-select-uf"],
                "TESTEM2_DDDFONE"  => $_POST["cat-input-testemunha2-ddd"],
                "TESTEM2_PREFONE"  => $_POST["cat-input-testemunha2-prefone"],
                "TESTEM2_NUMFONE"  => $_POST["cat-input-testemunha2-numfone"],
                "TPACIDENTE_ESOCIAL" => $_POST["cat-input-tipo-acidente"],
                ...
                //"TIPOINSCRICAOREGISTRADOR" =>  $_POST[""],
                //"CNPJCPFREGISTRADOR"   =>  $_POST[""],
                ...
                "NUMEROLOGRADOURO"     =>  $_POST["cat-input-funcionario-acidente-numero"],
            ...
            if ($_POST["cat-input-data-comum-obito"] != '')
                $val["DATACOMUNOBITO"] = funcoes::converterData($_POST["cat-input-data-comum-obito"]);
            if ($_POST["cat-input-data-protocolo"] != '')
                $val["DATAREGISTRO"] = funcoes::converterData($_POST["cat-input-data-protocolo"]);
            if ($_POST["cat-input-funcionario-data-nascimento"] != '')
                $val["DATANASCIMENTO"] = funcoes::converterData($_POST["cat-input-funcionario-data-nascimento"]);
            if ($_POST["cat-input-funcionario-data-emissao-ctps"] != '')
                $val["CTPSDATA"] = funcoes::converterData($_POST["cat-input-funcionario-data-emissao-ctps"]);
            if ($_POST["cat-input-data-emissao-rg"] != '')
                $val["RGDATAEMISSAO"] = funcoes::converterData($_POST["cat-input-data-emissao-rg"]);
            ...
            if ($cat->inserir($val)) {
                ...
                if ($cat->existeCAT($cat->getNumero())){
                    $xml = $cat->montarXML($_SESSION[config::getSessao()]["unidade"],
        ...
        <div id="cat-identificacao" class="tab-pane active cont">
            ...
            <div class="form-group-sm">
                ...
                <div class="col-sm-8" style="height: 58px;">
                    ...
                    <div class="input-group">
                        <input type="hidden" id="cat-input-tipo-acidente">
                        <input type="text" id="cat-input-descricao-tipo-acidente" readonly="" class="form-control input-sm" style="background-color: #fff; border-radius: 3px;">
                        <span class="input-group-btn">
                            <button class="btn btn-primary btn-xs" href="javascript: void(0)" id="form-button-pesquisa-tipo-acidente" style="height: 30px; padding-top: 4px">
                                <i class="fa fa-search"></i>
                            </button>
                        </span>
                    </div>
            ...
            <div class="form-group-sm">
                <div class="col-sm-12 col-md-12">
                    ...
                    <input type="text" autocomplete="no" id="cat-input-local-emissao" class="form-control input-sm" style="background-color: #fff; border-radius: 3px;">
                </div>
                <div class="clearfix"></div>
            </div>
            ...
            <div class="form-group-sm">
                <div class="col-sm-12" style="height: 58px;">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="cat-input-atestado-descricao-natureza-lesao"  autocomplete="no" class="form-control input-sm" style="background-color: #fff; border-radius: 3px;">
                        <span class="input-group-btn">
...
<script>
    ...
    $('#form-button-buscar-agente-causador').on('click', function(){
        ...
        $('#div-modal .modal-body').html('<center><div style="top: 30px; position: inherit;"><img src="img/loader2.gif"></div></center>');
        $('#div-modal .modal-body').load('agente-causador-pesquisa.php', { 'prefixo': 'cat-input' ,'div':'div-modal'});
    });   
    ...
    $('#form-button-pesquisa-parte-corpo').on('click', function(){
        ...
        $('#div-modal .modal-header h3').text('Pesquisa Parte do Corpo');
        $('#div-modal .modal-body').html('<center><div style="top: 30px; position: inherit;"><img src="img/loader2.gif"></div></center>');
        $('#div-modal .modal-body').load('parte-corpo-pesquisa.php', { 'prefixo': 'form-input' });
    });   
    ...
    $('#form-button-pesquisa-lateralidade').on('click', function(){
        ...
        $('#div-modal .modal-body').html('<center><div style="top: 30px; position: inherit;"><img src="img/loader2.gif"></div></center>');
        $('#div-modal .modal-body').load('lateralidade-pesquisa.php', { 'prefixo': 'form-input' });
    });   

    ...
    <body class="texture">
        <div id="cl-wrapper" class="error-container" style="background: url('img/bg.jpg')">
            <div class="page-error">
                ...
                <h2 class="description text-center">A página que você está tentando acessar não existe!</h2>
                <h3 class="text-center">Se você quiser <a href="javascript: void(0);" onclick="carregarPagina('dashboard', true, '');">clique aqui</a> para voltar!</h3>
            </div>
        </div>

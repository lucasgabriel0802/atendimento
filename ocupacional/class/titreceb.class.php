...
class titreceb implements iface {
    ...
    private $datavencimentooriginal = "";
    private $valortitulo            = "";
    private $situacao               = "";
    private $nossonumero            = "";
    private $banco                  = "";
    ...
    function getDataVencimentoOriginal(){ return $this->datavencimentooriginal; }
    ...
    function setDataVencimentoOriginal($valor){ $this->datavencimentooriginal = $valor; }
    ...
    function buscar($filtro = null, $limite = null, $ordem = null){
        $select = array("A.UNIDADE", "A.EMPRESA", "A.TITULO", "A.PARCELA", 
                        ...
                        "A.PERCMORADIA", "A.VENCIMENTOORIGINAL");
        ...
        for ($i = 0; $i < count($ret); $i++){
            ...
            $ti->setDataVencimentoOriginal($ret[$i]["VENCIMENTOORIGINAL"]);

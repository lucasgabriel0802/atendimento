                ...
                if (funcoes::validarHora($_GET["hora"])){   
                    ...
                    if ($ag->buscar(array("A.CODIGOUNIDADE" => $_SESSION[config::getSessao()]["unidade"],
                        ...
                        $fe->buscar(array("A.UNIDADE" => $ag->getUnidade()->getCodigo(),
                                          "A.EMPRESA" => $ag->getEmpresa()->getCodigo(),
                                          "A.MATRICULA" => $ag->getFuncionario()->getCodigo()), null, array("C.ORDEM" => "ASC", "B.DESCRICAO" => "ASC"));
...
//                            $pdf->Cell(55, 6, $fu->getPIS(), "", true);;
                            ...
                            $pdf->SetFont("Arial", "", 9);
                            $pdf->SetX(10);
                            $pdf->Cell(70, 6, "Exames:", true, "L");
                            $pdf->Cell(120, 6, utf8_decode("Orientações:"), true, "L");
                            $pdf->Ln();
                            $pdf->SetFont("Arial", "", 9);
                            ...
                            $pdf->SetFont("Arial", "IB", 11);
                            $pdf->Cell(190, 6, utf8_decode("O horário agendado, é referência para o atendimento."), "", true, "C");
                            $pdf->Cell(190, 6, utf8_decode("Procurar chegar, com 15 minutos de antecedência."), "", true, "C");
